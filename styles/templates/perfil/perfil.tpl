...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <table class="table table-striped table-hover ">
                    ...
                    <tr class="info">
                        ...
                        {else}
                        <td colspan="3" style="text-align: center;">No existen mas post.</td>
                        {/if}
                    </tr>
                    {/if}
                ...
                <nav>
                    <ul class="pager">
                        ...
                        <li class="disabled"><a href="#">Anterior</a></li>
                            {if $pags > 1}
                        <li><a href="?view=perfil&id={$smarty.get.id}&pag=2">Siguiente</a></li>
                            {else}
                        ...
                        <li class="disabled"><a href="#">Anterior</a></li>
                            {else}
                        <li><a href="?view=perfil&id={$smarty.get.id}&pag={$smarty.get.pag-1}">Anterior</a></li>
                            {/if}
                            {if $smarty.get.pag >= $pags}
                        <li class="disabled"><a href="#">Siguiente</a></li>
                            {else}

                        <li><a href="?view=perfil&id={$smarty.get.id}&pag={$smarty.get.pag+1}">Siguiente</a></li>
                            {/if}
                        {/if}
                    </ul>
                </nav>
            ...
            {else}
                <div class="media">
                    <div class="alert alert-danger" role="alert"><strong>El perfil solicitado no existe.</strong></div>
                </div>
                {/if}
            </div>
        </div>
